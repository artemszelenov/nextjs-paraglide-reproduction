      ...
      paraglideWebpackPlugin({
        ...
        urlPatterns: [
          ...
          },
          {
            ...
            localized: [["en", "https://thetrender.co.uk/:path(.*)?"]],
          },
          {
            pattern: "https://thetrender.id/:path(.*)?",
            localized: [["id", "https://thetrender.id/:path(.*)?"]],
          },
          {
          ...
          },
          {
            ...
            localized: [["de", "https://thetrender.de/:path(.*)?"]],
          },
          {
            pattern: "https://thetrender.com.br/:path(.*)?",
            localized: [["pt", "https://thetrender.com.br/:path(.*)?"]],
          },
          {
            pattern: "https://thetrender.ru/:path(.*)?",
            localized: [["ru", "https://thetrender.ru/:path(.*)?"]],
          },
        ],
      })
    );
